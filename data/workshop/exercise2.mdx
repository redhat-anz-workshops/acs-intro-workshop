...
<Zoom>
![report1](/static/images/exercise1/report1.png)
</Zoom>
...
<Zoom>
![report2](/static/images/exercise1/report2.png)
</Zoom>

This will open up the 'Create Policy' form. 

<Zoom>
![report3](/static/images/exercise1/report3.png)
</Zoom>
...
<Zoom>
![report4](/static/images/exercise1/report4.png)
</Zoom>

<Zoom>
![report5](/static/images/exercise1/report5.png)
</Zoom>

Click 'Next'. The next page defines the policy behavior. Select 'Build' and 'Deploy', and leave the 'Response method' set to 'Inform'.

<Zoom>
![report6](/static/images/exercise1/report6.png)
</Zoom>

Select 'Next', and this next page defines the policy criteria.

<Zoom>
![report7](/static/images/exercise1/report7.png)
</Zoom>

Expand 'image contents' on the right-hand side to see additional criteria you can use in the policy.

<Zoom>
![report8](/static/images/exercise1/report8.png)
</Zoom>

Locate the `CVE` field and drag it to the 'Policy section 1' field on the left. Update the CVE identifier for `CVE-2021-4034`.

<Zoom>
![report9](/static/images/exercise1/report9.png)
</Zoom>

Select 'Next'. This screen allows us to limit the policy scope to certain clusters or namespaces, or exlcude particular clusters from a policy. We're not going to make any changes here, so just click 'Next'.

<Zoom>
![report10](/static/images/exercise1/report10.png)
</Zoom>
...
<Zoom>
![report11](/static/images/exercise1/report11.png)
</Zoom>
...
<Zoom>
![report12](/static/images/exercise1/report12.png)
</Zoom>

Select 'API token' and then 'Generate token'

<Zoom>
![report13](/static/images/exercise1/report13.png)
</Zoom>

Enter your username for the token name and give the token a role of 'Analyst'.

<Zoom>
![report14](/static/images/exercise1/report14.png)
</Zoom>
